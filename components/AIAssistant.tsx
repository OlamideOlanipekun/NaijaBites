...
const AIAssistant: React.FC = () => {
  ...
  // Track scroll to show/hide chatbot button
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-[100] transition-all duration-300 ${!isOpen && !isVisible ? 'opacity-0 pointer-events-none translate-y-4' : 'opacity-100 translate-y-0'}`}>
      {isOpen ? (
